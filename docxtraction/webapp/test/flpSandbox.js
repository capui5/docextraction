		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Docx",
									"targetURL": "#comdocxtractiondocxtraction-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdocxtractiondocxtraction-display": {
								"semanticObject": "comdocxtractiondocxtraction",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.docxtraction.docxtraction",
									"url": sap.ui.require.toUrl("com/docxtraction/docxtraction")
								}
							}
						}
					}
